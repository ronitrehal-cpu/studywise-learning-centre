...
export function EnrollmentForm() {
  ...
  const schoolPrograms = [
    'Primary (Years 1–6): Maths & English',
    'Secondary (Years 7–10): Maths, English & Science',
    'VCE (Years 11–12)'
  ];
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="text-sm font-medium text-gray-600 mb-3">School Programs</h4>
                        <div className="space-y-3">
                          {schoolPrograms.map(program => (
                            <label key={program} className="flex items-start gap-3 cursor-pointer">
                              <input
                                type="checkbox"
                                checked={formData.subjects.includes(program)}
                                onChange={() => handleSubjectChange(program)}
                                className="w-5 h-5 text-blue-700 rounded focus:ring-2 focus:ring-blue-500 mt-0.5"
                              />
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-gray-600 mb-3">Exam Preparation</h4>
                        <div className="space-y-3">
                          {examPreparation.map(program => (
                            <label key={program} className="flex items-start gap-3 cursor-pointer">
                              <input
                                type="checkbox"
                                checked={formData.subjects.includes(program)}
