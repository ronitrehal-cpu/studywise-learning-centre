...
export function Hero() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-stone-50 to-stone-100 pt-28 pb-24 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
        <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-center">
          <div className="space-y-10">
            <Reveal delay={0.1}>
              <div className="space-y-5">
                <h1 className="text-[2.5rem] md:text-[3.25rem] lg:text-[4.25rem] font-bold text-gray-900 leading-[1.1] tracking-tight">
                  Helping students succeed in{' '}
                  <span className="text-sky-500 inline-block min-w-[200px] md:min-w-[320px]">
                    {currentText}
                    <span className="animate-pulse">|</span>
                  </span>
                </h1>
                <p className="text-xl md:text-2xl text-gray-600 max-w-xl leading-relaxed">
                  Curriculum-aligned in-centre tutoring for Primary to VCE students in Cranbourne West and Clyde North.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.3}>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button variant="primary" size="lg" onClick={scrollToEnrollment} className="px-10 py-4 text-lg">
                  Book a Free Assessment
                </Button>
                <Button variant="outline" size="lg" onClick={scrollToPrograms} className="px-10 py-4 text-lg">
                  View Programs
                </Button>
              </div>
            </Reveal>
