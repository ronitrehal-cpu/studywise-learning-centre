...
import { CalendarCheck, Download, FileText, TrendingUp, CheckCircle2 } from 'lucide-react';
...
export function StudentPortal() {
  ...
  const features = [
    { icon: CalendarCheck, text: 'View your class schedule' },
        ...
        <Section background="gradient">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-12 leading-relaxed">
              ...
              access lesson resources, view homework, and track progress — all in one place.
            </p>
